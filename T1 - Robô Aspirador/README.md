...
# Projeto I - Verificação de cenários e determinação de área limpa por um robô aspirador
...
Para a determinação da área a ser limpa, é necessário identificar quantos pontos iguais a 1 estão na região em que o robô se encontra, ou seja, é preciso determinar a área do componente conexo. Segue o algoritmo de reconstrução de componente conexo usando uma fila (FIFO):
